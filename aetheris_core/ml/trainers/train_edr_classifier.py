...
# --- Load Labels ---
labels = GeneratedTaxonomyLabel.objects.filter(classification_source="edr")
print(f"[DEBUG] Loaded {labels.count()} EDR labels")
...
print(f"[✓] Trained EDR classifier saved to: {MODEL_PATH}")
