...
# --- Load Labels ---
labels = GeneratedTaxonomyLabel.objects.filter(classification_source="hids")
print(f"[DEBUG] Loaded {labels.count()} HIDS labels")
...
print(f"[✓] Trained HIDS classifier saved to: {MODEL_PATH}")
