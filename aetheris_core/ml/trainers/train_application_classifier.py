...
# --- Load Labels ---
labels = GeneratedTaxonomyLabel.objects.filter(classification_source="application")
print(f"[DEBUG] Loaded {labels.count()} Application labels")
...
print(f"[✓] Trained Application classifier saved to: {MODEL_PATH}")
